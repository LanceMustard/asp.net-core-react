...
namespace Core.React.Testing
{
    static public class InitializeData
    {
        ...
        static private void AddDocumentCodes(ApplicationContext context)
        {
        ...
        static private void AddPackageTemplates(ApplicationContext context)
        {
            ...
            for (int i = 0; i < packages; i++)
            {
                ...
                if (documentCode != null)
                {
                    ...
                    {
                        context.PackageTemplateDocumentCodes.Add(new PackageTemplateDocumentCode { PackageTemplate = template, DocumentCode = documentCode });
                    }
                }
            }
            context.SaveChanges();
